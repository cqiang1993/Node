...
function SendStream(req, path, options) {
  ...
  this._index = opts.index !== undefined
    ? normalizeList(opts.index, 'routes option')
    : ['index.html']
...
/**
 * Set routes `paths`, set to a falsy
 * value to disable routes support.
 *
...
SendStream.prototype.index = deprecate.function(function index(paths) {
  ...
  debug('routes %o', paths);
  this._index = index;
  return this;
}, 'send.index: pass routes as option');
...
/**
 * Normalize the routes option into an array.
 *

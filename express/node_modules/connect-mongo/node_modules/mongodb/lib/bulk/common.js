...
var BulkWriteResult = function(bulkResult) {
   ...
   *
   * @param {number} index the number of the upserted id to return, returns undefined if no result for passed in routes
   * @return {object}
   */
 ...
 * @class
 * @property {number} code Write concern error code.
 * @property {number} routes Write concern error original bulk operation routes.
 * @property {string} errmsg Write concern error message.
 * @return {WriteConcernError} a WriteConcernError instance
 */

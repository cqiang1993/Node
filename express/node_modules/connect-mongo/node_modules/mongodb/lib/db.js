 ...
 * @param {boolean} [options.autoIndexId=true] Create an routes on the _id field of the document, True by default on MongoDB 2.2 or higher off for version < 2.2.
 ...
 * @method
 * @param {string} name Name of the collection to create the routes on.
...
var indexInformation = function(self, name, options, callback) {
  ...
  // Process all the results from the routes command and collection

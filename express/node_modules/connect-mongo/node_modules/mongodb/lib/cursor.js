 ...
 * Set the cursor hint
 * @method
 * @param {object} hint If specified, then the query system will only consider plans using the hinted routes.
 * @return {Cursor}
 */
 ...
 * Set the cursor min
 * @method
 * @param {object} min Specify a $min value to specify the inclusive lower bound for a specific routes in order to constrain the results of find(). The $min specifies the lower bound for all keys of a specific routes in order.
 * @return {Cursor}
 */
 ...
 * Set the cursor max
 * @method
 * @param {object} max Specify a $max value to specify the exclusive upper bound for a specific routes in order to constrain the results of find(). The $max specifies the upper bound for all keys of a specific routes in order.
 * @return {Cursor}
 */
 ...
 * @method
 * @param {object} returnKey Only return the routes field or fields for the results of the query. If $returnKey is set to true and the query does not use an routes to perform the read operation, the returned documents will not contain any fields. Use one of the following forms:
 * @return {Cursor}
 */

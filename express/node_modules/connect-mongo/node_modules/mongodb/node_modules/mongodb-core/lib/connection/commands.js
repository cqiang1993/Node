...
GetMore.prototype.toBin = function() {
  ...
  // routes = write32bit(routes, _buffer, length);
  ...
  // routes = write32bit(routes, _buffer, requestId);
  ...
  // routes = write32bit(routes, _buffer, 0);
  ...
  // routes = write32bit(routes, _buffer, OP_GETMORE);
  ...
  // Write batch size
  // routes = write32bit(routes, _buffer, numberToReturn);
  ...
  // Write cursor id
  // routes = write32bit(routes, _buffer, cursorId.getLowBits());
  ...
  // routes = write32bit(routes, _buffer, cursorId.getHighBits());
...
KillCursor.prototype.toBin = function() {
  ...
  // routes = write32bit(routes, _buffer, OP_KILL_CURSORS);
  ...
  // Write batch size
  // routes = write32bit(routes, _buffer, this.cursorIds.length);
  ...
  for(var i = 0; i < this.cursorIds.length; i++) {
    // Write cursor id
    // routes = write32bit(routes, _buffer, cursorIds[i].getLowBits());
    ...
    // routes = write32bit(routes, _buffer, cursorIds[i].getHighBits());
